...
public class ActivitySlotFriendRequest extends ActivitySlot {
	...
	public void doubleClick(int mx, int my) {
		if (Canvas.getCanvas().getUIHandler().getCurrentUI() instanceof UIInGameMenu)
			((UIInGameMenu) Canvas.getCanvas().getUIHandler().getCurrentUI()).changePopup(new UIPopupAcceptFriend(Canvas.getCanvas().getUIHandler().getCurrentUI(), index, ActivityManager.getActivity(index).minecraftName, ActivityManager.getActivity(index).message));
		if (Canvas.getCanvas().getUIHandler().getCurrentUI() instanceof UIInGameMenuFriend)
			((UIInGameMenuFriend) Canvas.getCanvas().getUIHandler().getCurrentUI()).changePopup(new UIPopupAcceptFriend(Canvas.getCanvas().getUIHandler().getCurrentUI(), index, ActivityManager.getActivity(index).minecraftName, ActivityManager.getActivity(index).message));
		if (Canvas.getCanvas().getUIHandler().getCurrentUI() instanceof UIInGameMenuPartyChat)
			((UIInGameMenuPartyChat) Canvas.getCanvas().getUIHandler().getCurrentUI()).changePopup(new UIPopupAcceptFriend(Canvas.getCanvas().getUIHandler().getCurrentUI(), index, ActivityManager.getActivity(index).minecraftName, ActivityManager.getActivity(index).message));
	}
