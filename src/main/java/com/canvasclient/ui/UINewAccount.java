...
public class UINewAccount extends UI {
	...
	public void init() {
		...
		interactables.add(new CheckBox(this, "I agree to the Canvas Terms and Conditions, as well as the Privacy Policy.", fX-(fW/2)+70, fY-(fH/2)+370, FontHandler.ROUNDED_BOLD.get(14), 0xFF999999));
		interactables.add(new CheckBox(this, "I wish to receive information about Canvas to my email address.", fX-(fW/2)+70, fY-(fH/2)+430, FontHandler.ROUNDED_BOLD.get(14), 0xFF999999));
	...
	public void render(float opacity) {
		...
		//Why need account
		if (Display.getWidth() >= 1280) {
			GuiHelper.drawStringFromTTF(FontHandler.ROUNDED_BOLD.get(20), fX-(fW/2)+860, fY-(fH/2)+21, "Why do I need a Canvas Account?", Utilities.reAlpha(ColorHelper.AQUA.getColorCode(), 1f*opacity));
