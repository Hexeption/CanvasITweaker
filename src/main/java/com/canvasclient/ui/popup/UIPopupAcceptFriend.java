...
public class UIPopupAcceptFriend extends UI {
	...
	public void init() {
		...
		interactables.add(new Button(this, "Accept", fX+(fW/2)-136, fY+(fH/2)-48, 120, 32, FontHandler.ROUNDED_BOLD.get(14), Canvas.getCanvas().getColorSchemeHandler().getCurrentBackground(), ResourceHelper.iconAccept[1], 16, Align.LEFT, Align.CENTER));
	}
