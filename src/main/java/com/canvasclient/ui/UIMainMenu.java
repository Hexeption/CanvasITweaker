...
public class UIMainMenu extends UI {
	...
	public void render(float opacity) {
		...
		GuiHelper.drawStringFromTTF(FontHandler.ROUNDED.get(200), Display.getWidth() / 2.0F, Display.getHeight() / 2.21875F, "canvas", Utilities.reAlpha(Canvas.getCanvas().getColorSchemeHandler().getCurrentForeground(), 1F  *  opacity), Align.CENTER, Align.CENTER);
