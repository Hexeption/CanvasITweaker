...
public class APIHelper {
	...
	public static final String PODS = "https://pods.meetKiLO.com/";
	public static final String FORUMS = "https://forums.meetKiLO.com";
	public static final String HELP = "https://help.meetKiLO.com/";
	public static final String ACCOUNT = "https://meetKiLO.com/account";
	public static final String ACCOUNT_ABOUT = "https://meetKiLO.com/about/my";
	public static final String TERMS_OF_SERVICE = "https://meetKiLO.com/about/tos";
	public static final String MAP_STORE = "https://store.meetKiLO.com/maps/";
	public static final String PREMIUM_AD = "https://kiloclient.com/buy-premium/?upgrade";
	public static final String WIDGETS = "https://kiloclient.com/";
	public static final String FRIEND = "https://kiloclient.com/";
	
	public static final String SUPPORT_EMAIL = "support@meetKiLO.com";
	public static final String ADDONS_MANAGE = "https://meetKiLO.com/account/addons";
	public static final String ORDER = "http://store.meetKiLO.com/order/";
	public static final String ADDONS_MANAGE_LOGIN = "https://meetKiLO.com/account/addons/?client_id=%s";
	public static final String PROFILE = "https://meetKiLO.com/account/friends/profile/%s";
	public static final String PARTY = "http://kiloclient.com";
	...
	public static final String CUSTOMISE = "https://kiloclient.com/me/";
	...
	public static String[] getClientDetails(String clientID) {
		try {
			...
			if (obj.length() == 11) {
				...
				return new String[] {clientID, kiloName, minecraftName, premium, email, status, nametag, checkTime, colorScheme, latestVersion, latestVersionURL, cd};
			} else {
	...
	public static String addServer(String i, String p) {
		...
		try {
			URL apiURL = new URL(String.format(ADD_SERVER, KiLO.getKiLO().getUserControl().clientID, i, p));
	...
	public static String deleteServer(String i) {
		...
		try {
			URL apiURL = new URL(String.format(DELETE_SERVER, KiLO.getKiLO().getUserControl().clientID, i));
	...
	public static void moveServer(String i, String method) {
		...
		try {
			URL apiURL = new URL(String.format(MOVE_SERVER, KiLO.getKiLO().getUserControl().clientID, i, method));
			apiURL.openStream();
		} catch (Exception localException) {
			localException.printStackTrace();
		}
	...
	public static List<Friend> getFriends(String clientID) {
		...
		try {
			...
			for(int i = 0; i < jsonArray.length(); i++) {
				...
				kiloname = jsonObject.getString("nickname");
	...
	*/
	public static void manageAddonsLogin() {
		...
		try {
			URL apiURL = new URL(String.format(ADDONS_MANAGE_LOGIN, KiLO.getKiLO().getUserControl().clientID));
			apiURL.openStream();
		} catch (Exception localException) {
			localException.printStackTrace();
		}
	...
	public static void hideStatus() {
		...
		try {
			URL apiURL = new URL(String.format(HIDE_STATUS, KiLO.getKiLO().getUserControl().clientID));
	...
	public static void getStatus() {
		...
		try {
			URL apiURL = new URL(String.format(STATUS, KiLO.getKiLO().getUserControl().clientID));
	...
	public static List<com.kiloclient.ui.interactable.slotlist.part.Message> getMessages(String clientID) {
		List<com.kiloclient.ui.interactable.slotlist.part.Message> list = new ArrayList<com.kiloclient.ui.interactable.slotlist.part.Message>();
		try {
			...
			for(int i = 0; i < jsonArray.length(); i++) {
				...
				list.add(new com.kiloclient.ui.interactable.slotlist.part.Message(username, message, String.format(PLAYER_HEAD, username, "128")));
			}
		} catch (Exception localException) {
			localException.printStackTrace();
		}
	...
	public static List<Notification> getUpdates(String clientID, String status, String ip) {
		...
		try {
			...
			for(int i = 0; i < jsonArray.length(); i++) {
				...
				if (jsonObject.has("picture")) { picture = jsonObject.getString("picture"); }
				if (jsonObject.has("first_name")) { kiloName = jsonObject.getString("first_name"); }
