...
public class UIInGameMenuFriend extends UI {
	...
	public void init() {
		...
		interactables.add(new IconButton(this, xPosition - (width / 2) + 860, yPosition - (height / 2) + 485,16, 16, KiLO.getKiLO().getColorSchemeHandler().getCurrentForeground(), this.send));
	...
	public void update(int mx, int my) {
		...
		if (serverLink == null && friend.ip != null) {
			serverLink = new Link(this, "\u00a7a" + friend.ip, xPosition - (width / 2) + 318 + FontHandler.ROUNDED_BOLD.get(14).getWidth("Online - Playing on "), yPosition - (height / 2) + 130 + FontHandler.ROUNDED_BOLD.get(25).getHeight(this.friend.kiloname), FontHandler.ROUNDED_BOLD.get(14), 0xFF67ac2a, Align.LEFT, Align.LEFT);
		}
		
		serverLink.x = xPosition - (width / 2) + 320 + FontHandler.ROUNDED_BOLD.get(14).getWidth("Online - Playing on ");
		serverLink.y = yPosition - (height / 2) + 127 + FontHandler.ROUNDED_BOLD.get(30).getHeight(this.friend.kiloname) - 1;
	...
	public void submit() {
		...
		if (msg != null && msg.length() > 0) {
			...
			new Thread() {
				@Override
				public void run() {
					if (APIHelper.sendMessage(KiLO.getKiLO().getUserControl().clientID, friend.mcname, msg)) {
						error = "";
					} else {
						sending = false;
					}
	...
	public void render(float opacity) {
		...
		if (coverImage.getTexture() != null) {
			...
			float scale = 0.822F;
			GuiHelper.drawRectangle(xPosition - (width / 2) + 200, yPosition - (height / 2) + 48, 852 * scale + xPosition - (width / 2) + 200, 320 * (scale / 1.5F) + yPosition - (height / 2) + 48, Utilities.reAlpha(KiLO.getKiLO().getColorSchemeHandler().getCurrentBackground(), 1F));
		...
		if (friendOnline) {
			GuiHelper.drawStringFromTTF(FontHandler.ROUNDED_BOLD.get(14), xPosition - (width / 2) + 319, yPosition - (height / 2) + 127 + FontHandler.ROUNDED_BOLD.get(30).getHeight(this.friend.kiloname), "\u00a7aOnline", ColorHelper.WHITE.getColorCode());
			GuiHelper.drawStringFromTTF(FontHandler.ROUNDED_BOLD.get(14), xPosition - (width / 2) + 319 + FontHandler.ROUNDED_BOLD.get(14).getWidth("Online "), yPosition - (height / 2) + 127 + FontHandler.ROUNDED_BOLD.get(30).getHeight(this.friend.kiloname), "- Playing on", Utilities.reAlpha(ColorHelper.GREY.getColorCode(), 1F));
			GuiHelper.drawTexturedRectangle(xPosition - (width / 2) + 322 + FontHandler.ROUNDED_BOLD.get(14).getWidth("Online - Playing on " + friend.ip + " "), yPosition - (height / 2) + 127 + FontHandler.ROUNDED_BOLD.get(30).getHeight(this.friend.kiloname), 10, 20, this.goTo, Utilities.reAlpha(ColorHelper.GREY.getColorCode(), 1F));
		} else {
			GuiHelper.drawStringFromTTF(FontHandler.ROUNDED_BOLD.get(14), xPosition - (width / 2) + 319, yPosition - (height / 2) + 127 + FontHandler.ROUNDED_BOLD.get(30).getHeight(this.friend.kiloname), "Offline", Utilities.reAlpha(ColorHelper.RED.getColorCode(), 1F));
		}
		...
		if (KiLO.getKiLO().getUserControl().kiloHead.getTexture() != null && !sending) {
			GuiHelper.drawTexturedRectangle(xPosition - (width / 2) + 475, yPosition - (height / 2) + 480, 30, 30, KiLO.getKiLO().getUserControl().kiloHead.getTexture(), 1f * opacity);
		} else {
		...
		GuiHelper.drawTexturedRectangle(xPosition - (width / 2) + 219, yPosition - (height / 2) + 385, 20, 20, ResourceHelper.iconProfile[1], !(friend.location.length() == 0) ? Utilities.reAlpha(KiLO.getKiLO().getColorSchemeHandler().getCurrentBackground(), opacity) : Utilities.reAlpha(ColorHelper.GREY.getColorCode(), opacity));
		GuiHelper.drawTexturedRectangle(xPosition - (width / 2) + 219, yPosition - (height / 2) + 420, 20, 20, ResourceHelper.iconSkype[1], !(friend.skype.length() == 0) ? Utilities.reAlpha(KiLO.getKiLO().getColorSchemeHandler().getCurrentBackground(), opacity) : Utilities.reAlpha(ColorHelper.GREY.getColorCode(), opacity));
		GuiHelper.drawTexturedRectangle(xPosition - (width / 2) + 219, yPosition - (height / 2) + 455, 20, 20, ResourceHelper.iconSteam[1], !(friend.steam.length() == 0) ? Utilities.reAlpha(KiLO.getKiLO().getColorSchemeHandler().getCurrentBackground(), opacity) : Utilities.reAlpha(ColorHelper.GREY.getColorCode(), opacity));
		GuiHelper.drawTexturedRectangle(xPosition - (width / 2) + 219, yPosition - (height / 2) + 490, 20, 20, ResourceHelper.iconWebsite[1], !(friend.website.length() == 0) ? Utilities.reAlpha(KiLO.getKiLO().getColorSchemeHandler().getCurrentBackground(), opacity) : Utilities.reAlpha(ColorHelper.GREY.getColorCode(), opacity));
		...
		GuiHelper.drawStringFromTTF(FontHandler.ROUNDED_BOLD.get(25), xPosition - (width / 2) + 319, yPosition - (height / 2) + 133, this.friend.kiloname, Utilities.reAlpha(ColorHelper.WHITE.getColorCode(), 0.8F));
		
		GuiHelper.drawStringFromTTF(FontHandler.ROUNDED_BOLD.get(25), xPosition - (width / 2) + 319 + FontHandler.ROUNDED_BOLD.get(25).getWidth(this.friend.kiloname + " "), yPosition - (height / 2) + 133, "(" + this.friend.mcname + ")", Utilities.reAlpha(ColorHelper.GREY.getColorCode(), 1F));
