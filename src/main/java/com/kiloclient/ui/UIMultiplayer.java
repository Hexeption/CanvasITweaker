...
import com.kiloclient.ui.interactable.slotlist.slot.ServerSlot;
...
public class UIMultiplayer extends UI {
	...
	public void init() {
		...
		interactables.add(new Button(this, "Add Server", fX+(fW/2)-270-8-128, fY+(fH/2)-48+8, 128, 32, FontHandler.ROUNDED_BOLD.get(12), KiLO.getKiLO().getColorSchemeHandler().getCurrentForeground(), ResourceHelper.iconAdd[1], 16));
		interactables.add(new Button(this, "Join Server", fX+(fW/2)-270+8, fY+(fH/2)-48+8-50, 270-16, 42, FontHandler.ROUNDED_BOLD.get(12), KiLO.getKiLO().getColorSchemeHandler().getCurrentForeground(), null, 0));
		...
		interactables.add(new Link(this, "", fX+(fW/2)-10, fY-(fH/2)+173+(FontHandler.ROUNDED_BOLD.get(12).getHeight()*3f)+(FontHandler.ROUNDED_BOLD.get(14).getHeight()*4), FontHandler.ROUNDED_BOLD.get(12), KiLO.getKiLO().getColorSchemeHandler().getCurrentBackground(), Align.RIGHT, Align.TOP));
		interactables.add(new Link(this, "", fX+(fW/2)-10, fY-(fH/2)+173+(FontHandler.ROUNDED_BOLD.get(12).getHeight()*3.5f)+(FontHandler.ROUNDED_BOLD.get(14).getHeight()*5), FontHandler.ROUNDED_BOLD.get(12), KiLO.getKiLO().getColorSchemeHandler().getCurrentBackground(), Align.RIGHT, Align.TOP));
	}
	...
	public void handleInteraction(Interactable i) {
		...
		case 1:
			...
			break;
		case 2:
			KiLO.getKiLO().getUIHandler().changeUI(new UIDirectConnect(this));
			break;
		case 3:
			KiLO.getKiLO().getUIHandler().changeUI(new UIAddServer(this));
			break;
		case 4:
	...
	public void render(float opacity) {
		...
		if (ss != null) {
			...
			GuiHelper.drawStringFromTTF(FontHandler.ROUNDED_BOLD.get(14), fls, fiy, ss.name != null?ss.name:"Minecraft Server", KiLO.getKiLO().getColorSchemeHandler().getCurrentForeground());
