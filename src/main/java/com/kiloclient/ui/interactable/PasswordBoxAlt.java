...
public class PasswordBoxAlt extends TextBoxAlt {
	...
	public PasswordBoxAlt(InteractableParent parent, String placeholder, float x, float y, float width, float height, TrueTypeFont font, int fontColor, int fontColorPlaceholder, Align fontAlignH, Align fontAlignV, boolean underline) {
		super(parent, placeholder, x, y, width, height, font, fontColor, fontAlignH, fontAlignV);
